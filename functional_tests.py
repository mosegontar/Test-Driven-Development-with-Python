...
class NewVisitorTest(unittest.TestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        # There is still a text box inviting her to add another iterm
        ...
        table = self.browser.find_element_by_id('id_list_table')
        rows = table.find_elements_by_tag_name('tr')
        self.assertIn('1: Buy peacock feathers', [row for row in rows])
        self.assertIn('2: Use peacock feathers to make a fly', [row for row in rows])
